...
// Exactly 16 bytes: UTF-8("vf-unwind-job-v1"). Keeping the domain literal makes the signed
// commitment interoperable with the relayer without ABI/string-encoding ambiguity.
