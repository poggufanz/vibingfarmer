      ...
      {proposer && (
        <div style={{ padding: '10px 14px', borderTop: '1px solid var(--border)' }}>
          ...
          <div style={{ fontSize: 12, lineHeight: 1.6 }}>
            <div><span style={{ color: '#c90', fontWeight: 600 }}>Proposer:</span> {proposer.action} ({Math.round((proposer.confidence || 0) * 100)}%) · &ldquo;{proposer.reasoning || ''}&rdquo;</div>
          ...
          {riskCompliance && (
            <div style={{ fontSize: 12, lineHeight: 1.6, marginTop: 4 }}>
              ...
              <div style={{ color: 'var(--text-muted)', fontSize: 11 }}>&ldquo;{riskCompliance.concerns?.[0] || 'No concerns'}&rdquo;</div>
