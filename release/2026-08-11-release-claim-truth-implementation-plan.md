...
**Goal:** Align expiry, yield, fee, and Explorer claims with the live Stellar system, then publish a validated evidence matrix and activate a fail-closed feature freeze for `v1.15.0-beta`.
...
- Candidate tag is exactly `v1.15.0-beta`; target branch is `dev`; Cloudflare Pages project is `vibing-farmer`.
